   ...
   children: [
     Container(  
                        decoration: BoxDecoration(
                          ...
                          child: Icon(Icons.pin_drop_rounded,color: kTeal400,)),
                           SizedBox(    height: MediaQuery.of(context).size .height *.02,),

                          Text(' كل مكان' ,style: TextStyle(color: kTeal400),)
   ],
 ),
                    ...
                    decoration: BoxDecoration(
                          ...
                          width: MediaQuery.of(context).size.width * .2,
                          height: MediaQuery.of(context).size.height * .1,
                          child: Icon(Icons.message,color: kTeal400,)),
                           SizedBox(    height: MediaQuery.of(context).size .height *.02,),

                           Text('info@example.com' ,style: TextStyle(color: kTeal400),)
                    ...
                    decoration: BoxDecoration(
                          ...
                          width: MediaQuery.of(context).size.width * .2,
                          height: MediaQuery.of(context).size.height * .1,
                          child: Icon(Icons.phone,color: kTeal400,)),
                           SizedBox(    height: MediaQuery.of(context).size .height *.02,),
                         Text('0123456789' ,style: TextStyle(color: kTeal400),)
            ...
            Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Row(children: [
          Icon(Icons.whatsapp_rounded,color: Colors.green, ),
          Text('0938752924')
                    ],) ,
